...
${TEST_HOME}/pocs/performance-test/shell/cleneup/calc.sh ${NUMBER_OF_CONTAINERS}
...
docker cp cygnus-demo:/hs_err_pid20.log ${TEST_HOME}/pocs/performance-test/log/cygnus-hs_err_pid20.log
