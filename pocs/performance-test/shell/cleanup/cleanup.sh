...
${TEST_HOME}/pocs/performance-test/shell/cleanup/08-get_fiware_cpu_docker_stats_shaping.sh
${TEST_HOME}/pocs/performance-test/shell/cleanup/copy_all_docker_logs.sh
${TEST_HOME}/pocs/performance-test/shell/cleanup/get_data_from_comet.sh ${NUMBER_OF_CONTAINERS}
