...
|**データ送信間隔**|1デバイスあたりのデータの送信間隔(秒)|決めた値|1|
|**データ送信回数**|1デバイスあたりのデータ送信回数|(デバイス起動時間＋測定時間＋ランニング時間×2)/データ送信間隔|87400|
|**デバイス起動合計時間**|全てのデバイスが起動するのにかける時間(秒)|デバイス数×デバイス起動間隔|400|
|**送信データタイプ**|送信データの内容([string] or [number])|決めた値|string|
|デバイス起動間隔|1デバイスあたりの起動間隔(秒)|決めた値|4|
|ランニング時間|負荷が定常状態にするためのランニング時間(秒)|決めた値|300|
|測定時間|試験データの対象とする測定時間(秒)|決めた値|86400|
